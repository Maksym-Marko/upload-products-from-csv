...
class MXUTWFC_Model
{
	...
	* Table name
	*/
	protected $table = MXUTWFC_TABLE_SLUG;
	...
	*/
	public function mxutwfc_get_row( $table = NULL, $wher_name, $wher_value )
	{
	...
	*/
	public function mxutwfc_get_results( $table = false, $wher_name = NULL, $wher_value = 1 )
	{
