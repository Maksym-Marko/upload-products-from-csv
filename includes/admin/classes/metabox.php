			...
			<?php elseif( $this->args['metabox_type'] == 'image' ) : ?>
				...
				<div class="mx-image-uploader">
					...
					<input
						...
						type="hidden"
						class="mxutwfc_upload_image_save"
						value="<?php echo $meta_value; ?>"
					/>
					...
					<img
						...
						style="width: 300px;"
						alt=""
						class="mxutwfc_upload_image_show"
						<?php echo $image_url == '' ? 'style="display: none;"' : ''; ?>						
					/>
					...
					<a
						href="#"
						class="mxutwfc_upload_image_remove"
						<?php echo $image_url == '' ? 'style="display: none;"' : ''; ?>
					>Remove Image</a>
